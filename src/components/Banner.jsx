        ...
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          <div className="flex-1 text-center font-secondary lg:text-left">
            <motion.h1 variants={fadeIn('up',0.3)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.7}}
             className=" text-[55px] font-bold leading-[0.8] mb-2 lg:text-8xl">
              Deepanshu <span>Agarwal</span>
            </motion.h1>
            <motion.div variants={fadeIn('up',0.4)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.7}} 
            className="mb-6 text-4xl font-secondary font-semibold uppercase lg:text-6xl leading-[1]">
              <div>
            ...
            <div>
              <motion.p variants={fadeIn('up',0.5)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.7}}
               className="mb-8 max-w-lg mx-auto lg:mx-0">
                ...
                voluptate alias tempore in. Nisi a, unde explicabo, incidunt
                temporibus quo tempora, placeat ad sed
              </motion.p>
              <motion.div variants={fadeIn('up',0.6)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.8}} 
          ...
          <motion.figure variants={fadeIn('down',0.5)} initial="hidden" whileInView={'show'} 
